...
# Script que mezcla los archivos de promedios 
# diarios en un  solo netCDF.
#############################################

#SBATCH -J merge_prom_dia_RH_Rmedina 
#SBATCH -p workq2
...
time srun -N1 -n1 --exclusive ncl merge_prom_dia_RH.ncl &
