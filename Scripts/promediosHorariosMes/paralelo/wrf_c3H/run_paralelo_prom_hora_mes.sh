...
# que calcula los promedios horarios por mes (T2,PREC,V)
###############################################

#SBATCH -J prom_hora_mes_rh 
#SBATCH -p workq2
#SBATCH -N 1 # Numero de Nodos 
#SBATCH --ntasks-per-node 12 # Número de tareas por nodo
#SBATCH -t 3-0:00 # Tiempo (D­HH:MM) 
...
N=11
for i in $(seq 0 $N);do
	time srun -N1 -n1 --exclusive ncl mes_i=$i paralelo_promediosHorariosXmes.ncl &
done
